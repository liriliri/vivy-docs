...
VIVY 支持 [Windows x64](https://release.liriliri.io/VIVY-1.0.0-win.7z) 和 [macOS ARM](https://release.liriliri.io/VIVY-1.0.0-arm64.dmg) 两个平台。
...
下载[安装包](https://release.liriliri.io/VIVY-1.0.0-win.7z)并解压到指定路径，双击打开 **VIVY.exe** 即可启动运行。
...
macOS 平台对内存和存储空间的要求与 Windows 一致，仅支持 ARM 芯片，直接下载[安装包](https://release.liriliri.io/VIVY-1.0.0-arm64.dmg)并安装运行即可。